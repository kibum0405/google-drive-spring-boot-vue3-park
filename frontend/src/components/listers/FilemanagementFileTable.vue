        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <FilemanagementFile :offline="offline"  :isNew="true" :editMode="true" :value="newValue" @add="append" v-if="tick"/>
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "uploadedBy", value: "uploadedBy" },
                    { text: "downloadedCount", value: "downloadedCount" },
