    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    ...
                    <div class="secondary-text-color" style="margin-left:30px;">파일에 대한 설명</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <FilemanagementFile :offline="offline"  :isNew="true" :editMode="true" :value="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <FilemanagementFile :offline="offline"
                    :value="values[index]"
                    @delete="remove"/>
            </v-col>
        </v-row>
...
<script>
    ...
    import FilemanagementFile from './../FilemanagementFile.vue';
